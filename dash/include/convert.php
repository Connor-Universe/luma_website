...
$coin1 = $row_krypto['name'];
  ...
  $get_request = "select * from investment_request where referal_code = '$referal_code2' and id_no = $id_no2";
...
$reference_id = mt_rand(10000000 , 99999999);
  ...
  $plan_name = $row_plan['name'];
        ...
        echo"    <script>
        setTimeout(function(){
           window.location.href = 'deposit_invoice.php';
        });
     </script>";
...
$mail->Subject = "Referal bonus email: $site_name3";
