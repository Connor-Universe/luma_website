...
<div class="container">
  <div class="row">
    ...
    <a href="images/cert1.pdf"> <img src="images/cert1.png" style="width:30%; margin-left:35%;" alt=""></a>
        ...
        <br> <br>
<h3 class="zoomIn wow">White <strong>Paper</strong></h3>
<div class="container">
  <div class="row">
    <div class="col-lg-6">
    <p>Read our White Paper Documenation to understand more about our company and what we strive to achieve at <?php echo"$site_name3";?></p>
    </div>
    <div class="col-lg-6">
    <a href="images/lumaexchange-whitepaper2.pdf"> <img src="images/luma2.png" alt=""></a>
    </div>
  </div>
</div>
