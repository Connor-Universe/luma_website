        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <div class="banner_infos banner_infos_sub">
              <h1 class="bounceInDown wow">Terms & <span>Conditions</span></h1>
          </div>
        </div>
      </div>
    </section>
...
<?php echo"$site_name3";?> is not available to the general public and is opened only to the qualified members of <?php echo"$site_name3";?>, the use of this site is restricted to our members and to individuals personally invited by them. Every deposit is considered to be a private transaction between the <?php echo"$site_name3";?> and its Member.<br><br>
...
As a private transaction, this program is exempt from the US Securities Act of 1933, the US Securities Exchange Act of 1934 and the US Investment Company Act of 1940 and all other rules, regulations and amendments thereof. We are not FDIC insured. We are not a licensed bank or a security firm.<br><br>
  You agree that all information, communications, materials coming from <?php echo"$site_name3";?> 
...
All the data giving by a member to <?php echo"$site_name3";?> will be only privately used and not disclosed to any third parties. <?php echo"$site_name3";?> is not responsible or liable for any loss of data.<br><br>
...
<?php echo"$site_name3";?> is not responsible or liable for any damages, losses and costs resulting from any violation of the conditions and terms and/or use of our website by a member. You guarantee to <?php echo"$site_name3";?> that you will not use this site in any illegal way and you agree to respect your local, national and international laws.<br><br>
...
<?php echo"$site_name3";?> reserves the right to accept or decline any member for membership without explanation.<br><br>
